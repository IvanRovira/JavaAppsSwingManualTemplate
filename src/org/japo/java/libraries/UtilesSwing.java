...
public class UtilesSwing {
    ...
    // Perfiles LnF compatibles con Windows
    ...
    // Constante que contiene el nombre del LNF Nimbus, que es el LNF por defecto de JFrame.
    ...
    public static boolean establecerLnF(String lnf) {
        ...
        // y por cada uno de los disponibles coge el nombre, si el nombre del LnF actual coincide con el que le hemos pasado, lo establece y sigue recorriendo (poca eficiencia).
        // UIManager es la clase que gestiona el aspecto visual de Swing. LookAndFeelInfo es una clase que está dentro de la clase UIManager
        try {
    ...
    public static void establecerFavicon(JFrame ventana, String rutaFavicon) {
        try {
            // Ruta Favicon > URL Favicon. A partir de la ruta se crea un objeto de la clase URL, con la URL se crea un objeto de la clase IconImage,
            // y a partir del objeto de IconImage se crea un objeto de la clase Image.
